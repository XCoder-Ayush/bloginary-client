...
function Blogstory() {
  ...
  return (
    <>
      ...
      <p className="text-5xl text-gray-500 dark:text-white ml-96">
        <svg
          className="w-6 h-6 text-gray-800 dark:text-white"
          aria-hidden="true"
          xmlns="http://www.w3.org/2000/svg"
        ...
        Post your blog story
      </p>
      <br></br>
      <br></br>
      <svg
        className="w-6 h-6 text-gray-800 dark:text-white cursor-pointer ml-96"
        aria-hidden="true"
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
      ...
      <p className="ml-96">Add your blog</p>
      ...
      <p className="text-2xl text-gray-500 dark:text-white ml-96 text-center">
        Our Sponsers
      </p>
      <Marquee>
